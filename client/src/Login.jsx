  ...
  return (
    <>
      <section id="container-main-left">
        ...
        <section id="container-left-contents">
          <section id="contents">
            <div id="website-brand">
              <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
                <path d="M0 27V6H6V0H21V12H27V27H15V21H12V27H0ZM3 24H6V21H3V24ZM3 18H6V15H3V18ZM3 12H6V9H3V12ZM9 18H12V15H9V18ZM9 12H12V9H9V12ZM9 6H12V3H9V6ZM15 18H18V15H15V18ZM15 12H18V9H15V12ZM15 6H18V3H15V6ZM21 24H24V21H21V24ZM21 18H24V15H21V18Z" fill="white" />
              </svg>
              <div>PadPal</div>
            </div>
            <div id="website-motto">Find your home, build your tribe.</div>
            <div id="website-claim">
              The safest platform for university students to find compatible roommates and verified housing.
            </div>
          </section>
        </section>
      </section>
      ...
      <section id="container-main-right">
        <section id="container-sign-in">
          <section id="container-welcome-back">
            <span id="welcome-back">Welcome back</span>
            <span className="some-details">Please enter your details to sign in.</span>
          </section>

          <section id="container-authentication">
            <section id="container-credentials">
              <section className="container-cred-input">
                <span className="credential-text">Email Address</span>
          ...
          <section id="container-additional-links">
            <Link id="admin-login-button" className="nostyle" to="/admin-login" target="_blank">Admin?</Link>
          </section>
        </section>
      </section>
    </>
