                ...
                <section id="navbar-buttons">
                    <section id="navbar-options">
                        <Link to="/admin-dashboard">
                            <div className={selected === 'dashboard' ? 'navbar-option-button selected': 'navbar-option-button'} onClick={() => setSelected('dashboard')}>
                        ...
                        <Link to="/admin-listings">
                            <div className={selected === 'listings' ? 'navbar-option-button selected': 'navbar-option-button'} onClick={() => setSelected('listings')}>
                        ...
                        <Link to="/admin-moderations">
                            <div className={selected === 'moderations' ? 'navbar-option-button selected': 'navbar-option-button'} onClick={() => setSelected('moderations')}>
