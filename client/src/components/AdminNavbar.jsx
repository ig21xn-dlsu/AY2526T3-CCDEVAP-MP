                    ...
                    <section id="navbar-options">
                        <a href="admin-dashboard.html">
                            <div className="navbar-option-button">
                                ...
                                <div className="navbar-option-button-text">Dashboard</div></div></a>
                    
                        <a href="admin-users.html"><div className="navbar-option-button">
                            ...
                            <div className="navbar-option-button-text">Users</div></div></a>
