...
function AdminNavbar({ onOpenSettings }) {
    ...
    return (
        <section id="nav-drawer" className={isOpen  ?  'open' : ''}>
            <div id="toggle-handle" onClick={toggleNavBar}>
                <svg id="arrow" className={arrowUp ? '' : 'toggled'} width="20" height="20" viewBox="0 0 20 20"><path d="M5 12l5-5 5 5" fill="none" stroke="#0050CB" strokeWidth="2"/></svg>
            </div>
            ...
            <section id="admin-navbar">
                ...
                <section id="navbar-buttons">
                    <section id="navbar-options">
                        <Link to="/admin-dashboard">
                            <div className={location.pathname === '/admin-dashboard' ? 'navbar-option-button selected': 'navbar-option-button'}>
                ...
                <section id="navbar-settings">
                    <section id="admin-settings">
                        <div className="navbar-option-button" id="dark-mode-button" role="switch" aria-checked={isDark} onClick={toggleTheme} >
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            ...
                            <div className="navbar-option-button-text">{isDark ? 'Light Mode' : 'Dark Mode'}</div>
                            <div className={`theme-toggle-switch ${isDark ? 'on' : ''}`}>
                                <div className="theme-toggle-knob" />
                            </div>
                        </div>
                            
                    <div className="navbar-option-button" id="settings-button" onClick={onOpenSettings}>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none"> <path d="M2 18C1.45 18 0.979167 17.8042 0.5875 17.4125C0.195833 17.0208 0 16.55 0 16V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H9V2H2V16H9V18H2ZM13 14L11.625 12.55L14.175 10H6V8H14.175L11.625 5.45L13 4L18 9L13 14Z" fill="currentColor" className="danger-icon"/> </svg>
