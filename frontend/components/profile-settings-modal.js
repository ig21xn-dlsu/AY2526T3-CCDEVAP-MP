    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        * {
        ...
        /* ── Modal shell ───────────────────────────────────────────────
           width: min() keeps it ≤ 42rem but also ≤ (100vw − 2rem),
           so it never clips at any browser-zoom level.
           max-height + flex-column let the header/footer stay pinned
           while #modal-main scrolls independently.
        ─────────────────────────────────────────────────────────────── */
        #settings-modal {
          position: absolute;
          top: 50%;
        ...
        @media (max-width: 768px) {
          ...
          /* Profile picture: stack avatar above text + button */
          #profile-picture-container {
            flex-direction: column;
            align-items: center;
            text-align: center;
          ...
          /* Password pair: stack vertically */
          #old-new-password {
            flex-direction: column;
            gap: 1.25rem;
          }
        ...
        /* ═══════════════════════════════════════════════════════════════
           VERY SMALL  ≤ 380 px  (e.g. iPhone SE)
           – collapse footer buttons to fill available space evenly
        ═══════════════════════════════════════════════════════════════ */
      ...
      <section id="settings-modal">
          ...
          <section id="personal-info">
            ...
            <section id="personal-info-content">
              ...
              <section class="personal-info-input">Email Address
                <div class="info-container"><input type="text" placeholder="ian_gabriel_ilagan@dlsu.edu.ph"></div>
              </section>
            </section>
          </section>
        ...
        <section id="modal-footer">
          ...
          <section class="clickable" id="save-changes-button">
